      ...
      <Dialog open={ this.state.pleaseWaitVisible } disableBackdropClick={ true } disableEscapeKeyDown={ true }
       ...
       <div className="centerArea">
        ...
        <div className="centerViews">
          ...
          { (this.state.currentView === "contact" || this.state.currentView === "contactAdd" || this.state.currentView === "contactUpdate" ) &&
            <ContactView state={ this.state } /> /* change for new state.currentView*/
          }
        </div>
       </div>
