...
const ContactView = ({ state }) => (react_1.default.createElement("form", null,
    ...
    state.currentView === "contact" &&
        react_1.default.createElement(Button_1.default, { variant: "contained", color: "primary", size: "small", style: { marginTop: 10 }, onClick: () => state.showComposeMessage("contact") }, "Send Email")));
